...
<div>
  <img src={logo}  className='h-10 w-50' alt="" />
  <p className='text-[16px] leading-7 font-[400] text-textColor mt-4'>Copyright © {year} developed by Pratik Dubey all right reserved.</p>
